                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto"
                                            ...
                                            height="674" alt="Main product image" />
                                        ...
                                        @foreach (explode(',', $product->images) as $gimg)
                                            <div class="swiper-slide product-single__image-item">
                                                <img loading="lazy" class="h-auto"
                                                    ...
                                                    width="674" height="674" alt="Product thumbnail" />
                                                <a data-fancybox="gallery"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto"
                                            ...
                                            height="104" alt="Main product image" />
                                    </div>

                                    <!-- Check if $product->images exists and loop through it if it does -->
                                    @if (!empty($product->images))
                                        @foreach (explode(',', $product->images) as $gimg)
                                            <div class="swiper-slide product-single__image-item">
                                                <img loading="lazy" class="h-auto"
                    ...
                    @else
                        <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                            ...
                            <div class="product-single__addtocart">
                                ...
                                <button type="submit"
                                    class="btn btn-primary btn-addtocart "data-aside="cartDrawer">Add toCart</button>
                            </div>
                        </form>
                    @endif
                        ...
                        @foreach ($rproducts as $rproduct)
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details', ['id' => $rproduct->id]) }}">
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title"><a
                                            href="{{ route('shop.product.details', ['id' => $rproduct->id]) }}">{{ $rproduct->name }}</a>
                                    </h6>
