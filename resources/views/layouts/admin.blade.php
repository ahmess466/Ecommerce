            ...
            if (searchQuery.length > 2) {
                $.ajax({
                    ...
                    success: function(data) {
                        $("#box-content-search").html('');  // Clear the previous results
                        $.each(data, function(index, item) {
                            var url = "{{ route('admin.products.edit', ['id' => ':id']) }}";
                            var link = url.replace(':id', item.id);  // Replace with the actual item id
                    ...
                    error: function(jqXHR, textStatus, errorThrown) {
                        console.error("Search error:", textStatus, errorThrown);  // Error handling for debugging
                    }
                });
            }
        });
