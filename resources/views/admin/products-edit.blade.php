...
@section('content')
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-edit-product -->
            <form class="tf-section-2 form-edit-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.products.update', ['id' => $product->id]) }}">
                @csrf
                @method("PUT")
        ...
        <script>
            $(function() {
                ...
                $("#myFile").on("change", function(e) {
                    ...
                    if (file) {
                        <img id="imgpreview_img" src="" class="effect8" alt="">
                        $("#imgpreview").show();
                    }
                });
